        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-16 bg-portfolio-card border border-portfolio-border rounded-lg p-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
              <div>
                <h2 className="text-2xl font-bold text-portfolio-primary mb-2">
                  Resume
                </h2>
                <p className="text-portfolio-secondary">
                  Download my CV for more details on experience and skills.
                </p>
              </div>
              <a
                href="/cv_lucasvidela.pdf"
                download
                className="inline-flex items-center gap-2 px-6 py-3 bg-portfolio-accent/10 text-portfolio-accent border border-portfolio-accent/20 rounded-lg font-mono text-sm hover:bg-portfolio-accent/20 hover:border-portfolio-accent/40 transition-all duration-300"
              >
                <svg
